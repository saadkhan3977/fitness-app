...
Route::group(['middleware' => ['api','auth:api'], 'prefix' => 'auth'], function () {
    ...
    Route::post('user-profile', [\App\Http\Controllers\Api\UserController::class, 'profile'])->name('user-profile');
    ...
    //     Route::delete('quote_image_delete/{id}',[App\Http\Controllers\Api\Member\QuoteController::class,'image_destroy']);
	...
	//     Route::post('bid_cancel/{id}',[App\Http\Controllers\Api\Member\QuoteController::class,'bid_cancel']);
